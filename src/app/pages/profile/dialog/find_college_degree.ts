              ...
              <div class="col-md-12">
                  <nb-card size="large">
                      <nb-list>
                          ...
                          <nb-list-item *ngFor="let college of colleges?.degree_info | filter:{school_name:filterText}" style="padding: 0;">
...
export class find_College_Degree {
@Input() title: string;
...
constructor(protected ref: NbDialogRef<find_College_Degree>,
  ...
  startSearch(search_type,country_value) {
    ...
    this.api.getAllEducationDataFilter(this.Input_Search,this.SelectedCountries,"degree").subscribe(res=> {
      this.colleges = res;
    });     
  }
  ...
  searched_college_value() {
    ...
    this.api.searchedCollegeDetais(this.radio_check,"degree").subscribe(res=> {
